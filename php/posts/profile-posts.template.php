<div class="post-container">
    <div class="all-publications">
        <script>
            // Déclaration d'une variable permettant d'afficher un bouton avec le tag correspondant
            let buttonText;
        </script>
        <?php
        ...
        foreach ($posts as $post) { ?>
            ...
            // if ($post_author_id != $_USERS['user_id']) {
            //     continue;
            // }
            ...
            // $users_nickname = $_USERS['user_nickname'];
            if (isset($_GET['user_nickname'])) {
                $users_nickname = $_GET['user_nickname'];
            } elseif ($_USER['user_nickname']) {
                $users_nickname = $_USER['user_nickname'];
            }

            if ($_AUTHOR['user_nickname'] === $users_nickname) {
